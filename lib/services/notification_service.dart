...
class NotificationService {
  ...
  /// Channel IDs are incremented to _v8 to force Android to recreate them fresh with sound settings.
  static const String prayerChannelId = 'prayer_alerts_v8';
  static const String qazaChannelId = 'qaza_checks_v8';
  static const String safarChannelId = 'safar_dua_channel_v8';
  ...
  static const AndroidNotificationDetails _prayerAndroidDetails =
    ...
    playSound: true,
    sound: RawResourceAndroidNotificationSound('azan'),
    // Using notification usage instead of alarm to see if it plays on standard volume
